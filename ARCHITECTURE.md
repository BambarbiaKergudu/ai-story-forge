...
**Валидация ответа LLM.** Схема zod: 4 сцены, у каждой непустой `caption`,
`imagePrompt` на английском (не короче 20 символов, без верхнего предела),
`shotType` из перечисления. При провале —
